...
# Needed variables for tutorial #1
class_names = ['T-shirt/top', 'Trouser', 'Pullover', 'Dress', 'Coat', 
               'Sandal', 'Shirt', 'Sneaker', 'Bag', 'Ankle boot']

# First tutorial : Classification
...
def Classification():
    ...
    print('Length of the train labels :', len(train_labels))
    ...
    print(predictions[0])
    print('Max argument: ', np.argmax(predictions[0]))
    print('Max argument validation: ', test_labels[0])
    #   Single prediction
    i = 15;
